...
var nicEditorConfig = bkClass.extend({
	buttons : {
		...
		'underline' : {name : __('Podčiarknutie'), command : 'Underline', tags : ['U'], css : {'text-decoration' : 'underline'}, key : 'u'},
		'left' : {name : __('Zarovnanie vľavo'), command : 'justifyleft', noActive : true},
		'center' : {name : __('zarovnanie na stred'), command : 'justifycenter', noActive : true},
		'right' : {name : __('Zarovnanie vpravo'), command : 'justifyright', noActive : true},
		'justify' : {name : __('Zarovnanie do bloku'), command : 'justifyfull', noActive : true},
		'ol' : {name : __('Číslovaný zoznam'), command : 'insertorderedlist', tags : ['OL']},
		'ul' : 	{name : __('Odrážkový zoznam'), command : 'insertunorderedlist', tags : ['UL']},
		'subscript' : {name : __('Dolný index'), command : 'subscript', tags : ['SUB']},
		'superscript' : {name : __('Horný index'), command : 'superscript', tags : ['SUP']},
		'strikethrough' : {name : __('prečiarknutie'), command : 'strikeThrough', css : {'text-decoration' : 'line-through'}},
		'removeformat' : {name : __('Odstrániť formát'), command : 'removeformat', noActive : true},
		'indent' : {name : __('Odsadenie textu'), command : 'indent', noActive : true},
	...
	iconList : {"xhtml":30,"bgcolor":18,"forecolor":17,"bold":1,"center":11,"hr":30,"indent":13,"italic":2,"justify":12,"left":9,"ol":8,"outdent":14,"removeformat":30,"right":10,"save":16,"strikethrough":4,"subscript":6,"superscript":5,"ul":7,"underline":3,"image":21,"link":19,"unlink":20,"close":15,"arrow":23,"upload":22}
...
var nicEditor = bkClass.extend({
	...
	getIcon : function(iconName,options) {
		...
		return {backgroundImage : "url('"+((icon) ? this.options.iconsPath : file)+"')", backgroundPosition : ((icon) ? ((icon-1)*-20) : 0)+'px 0px'};	
	},
...
var nicEditorButton = bkClass.extend({
	...
	setBg : function(state) {
		switch(state) {
			case 'hover':
				var stateStyle = {border : '1px solid #326389', backgroundColor : '#4589be', borderRadius: '1px'};
				break;
			case 'active':
				var stateStyle = {border : '1px solid #638631', backgroundColor : '#81ae40', borderRadius: '1px'};
				break;
			default:
...
var nicEditorPane = bkClass.extend({
	construct : function(elm,nicEditor,options,openButton) {
		...
		if(openButton && !openButton.options.noClose) {
			this.close = new bkElement('div').setStyle({'float' : 'right', height: '20px', width : '20px', cursor : 'pointer'}).setStyle(this.ne.getIcon('close',nicPaneOptions)).addEvent('mousedown',openButton.removePane.closure(this)).appendTo(this.pane);
		}
